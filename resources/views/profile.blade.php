  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
    	...
    	<div class="modal-body">
			...
			<div class="mobile-pdf" style="display: none;">
				<a  href="/downloadables/RUNKITEK-2019-FAQS.pdf" class="btn btn-primary" target="_blank">View PDF</a>
			</div>
    	</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
    	...
    	<div class="modal-body">
			...
			<div class="mobile-pdf" style="display: none;">
				<a  href="/downloadables/ACCIDENT-WAIVER-AND-RELEASE-OF-LIABILITY-FORM.pdf" class="btn btn-primary" target="_blank">View PDF</a>
			</div>
    	</div>
    	<div class="modal-footer">
